...
impl MusicGenAudioEncodec {
    ...
    pub async fn encode<Cb: Fn(usize, usize) + Sync + Send + 'static>(
        &self,
        ...
        // TODO: There's something weird here. If I put this block inside the `async move` future,
        // the channel does not periodically the messages, instead, it pulls them up in batches of
        // 100 in a very clunky way.
